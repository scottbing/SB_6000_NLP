...
text = (
    ...
    (
        "Today I went to the zoo. I saw a _. large _. jumping up and down in its tree."
...
barVar = DoubleVar()
barVar.set(0)
progress = Progressbar(originalframe, orient=HORIZONTAL, style='black.Horizontal.TProgressbar', variable=barVar,
